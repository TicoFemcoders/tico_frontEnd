  ...
  return (
      ...
      >
        <Box sx={{ textAlign: "center", mb: "20px" }}>
          ...
          <Box sx={{ fontSize: "18px", fontWeight: 700, color: "text.primary" }}>{title}</Box>
          <Box sx={{ fontSize: "13px", color: "text.secondary", mt: "6px", lineHeight: 1.5 }}>
        ...
        <Box sx={{ textAlign: "center", fontSize: "11px", color: "text.subtle", mb: "20px" }}>
        ...
        <Box sx={{ mb: "12px" }}>
          <Box component="label" sx={{ display: "block", fontSize: "12px", fontWeight: 600, color: "text.primary", mb: "6px" }}>
            Nueva contraseña <Box component="span" sx={{ color: "primary.main" }}>*</Box>
          </Box>
          <TextField fullWidth type="password" placeholder="Mínimo 8 caracteres" value={password} onChange={(e) => setPassword(e.target.value)} />
        </Box>

        <Box sx={{ mb: "16px" }}>
          <Box component="label" sx={{ display: "block", fontSize: "12px", fontWeight: 600, color: "text.primary", mb: "6px" }}>
            Confirmar contraseña <Box component="span" sx={{ color: "primary.main" }}>*</Box>
          </Box>
          <TextField fullWidth type="password" placeholder="Repite la contraseña" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
        </Box>
